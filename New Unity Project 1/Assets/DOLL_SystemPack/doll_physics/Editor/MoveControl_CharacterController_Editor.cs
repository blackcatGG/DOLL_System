...
[CustomEditor (typeof(MoveControl_CharacterController))]
public class MoveControl_CharacterController_Editor : Editor {

    public override void OnInspectorGUI()
    {
        var obj = target as MoveControl_CharacterController;
